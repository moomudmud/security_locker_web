        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Employees Management</h1>
                    ...
                    <div style="overflow-x:auto;">
                        <table class="table table-striped  table-hover table-responsive table-bordered">
                            ...
                            <tr>
                                ...
                                <td>Role <br>
                                    <input type="radio" name="role" <?php if (isset($gender) && $gender == "staff") echo "checked"; ?> value="staff">Staff
                                    <input type="radio" name="role" <?php if (isset($gender) && $gender == "admin") echo "checked"; ?> value="admin">Admin
                                    <input type="radio" name="role" <?php if (isset($gender) && $gender == "super admin") echo "checked"; ?> value="Super admmon">Super admin
                            <tr>
                        ...
                        <table id="dataTable" class="table table-striped">
                            <thead style="vertical-align: top;">
                                <a href="../signin/register.php" class="btn btn-success">+ADD </a>
                            ...
                            <tbody>
                                <?php
                                if (isset($_GET['employee_id']) or isset($_GET['first_name']) or isset($_GET['phone']) or isset($_GET['role'])) {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <center><a href="../signin/register_edit.php?employee_id=<?= $row['employee_id']; ?>" class="btn btn-warning btn-sm">EDIT</a></center>
                                        </td>
                                        <td>
                                            <center><a href="../signin/register_edit_delete.php?employee_id=<?= $row['employee_id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('ยืนยันการลบข้อมูล !!');">DELETE</a></center>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
