        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Customers log</h1>
                    <ol class="breadcrumb mb-2">
                        <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
                        <li class="breadcrumb-item active">Customers log</li>
                    </ol>
                    <div style="overflow-x:auto;">
                        <table class="table table-striped  table-hover table-responsive table-bordered">
                            ...
                            <td align='left'><button type="button" class="btn btn-primary dataExport" data-type="excel" data-filename="customers_log">Export XLS</button></a></td>
                        ...
                        <table id="dataTable" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['customer_id']) or isset($_GET['first_name'])) {
                                    $customer_id = "%{$_GET['customer_id']}%";
                                    $Query = "SELECT * FROM tb_customer_log l
                                              LEFT JOIN tb_mas_customers c ON l.customer_id = c.customer_id
                                              WHERE (l.customer_id     LIKE '$customer_id'     OR '$customer_id'     IS NULL) ";
