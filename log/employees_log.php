        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Employees log</h1>
                    <ol class="breadcrumb mb-2">
                        <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
                        <li class="breadcrumb-item active">Employees log</li>
                    </ol>
                    <div style="overflow-x:auto;">
                        <table class="table table-striped  table-hover table-responsive table-bordered">
                            <tr>
                                <td>Employees ID<input type="search" name="employee_id" class="form-control"></td>
                            ...
                            <td align='left'><button type="button" class="btn btn-primary dataExport" data-type="excel" data-filename="employee_log">Export XLS</button></a></td>
                        ...
                        <table id="dataTable" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['employee_id']) or isset($_GET['first_name'])) {
                                    $employee_id = "%{$_GET['employee_id']}%";
                                    $first_name = "%{$_GET['first_name']}%";

                                    $Query = "SELECT * FROM tb_employee_log l
                                              LEFT JOIN tb_mas_employees e ON l.employee_id = e.employee_id
                                              WHERE (l.employee_id     LIKE '$employee_id' OR '$employee_id' IS NULL) 
                                              AND   (e.first_name  LIKE '$first_name' OR '$first_name'      IS NULL)";
