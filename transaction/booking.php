                ...
                <div class="container-fluid px-4">
                    ...
                    <div style="overflow-x:auto;">
                        <table class="table table-striped  table-hover table-responsive table-bordered">
                            <tr>
                                <td>Booking ID<input type="search" name="customer_id" class="form-control"></td>
                                <td>Owner/PA<input type="search" name="first_name" class="form-control"> </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>Status<select class="form-control" name="locker" id="locker">
                                        <option value="">---SELECT---</option>
